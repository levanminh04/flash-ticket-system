...
public class SecurityConfig {
    ...
    // Thêm giá trị mặc định sau dấu hai chấm (:)
    @Value("${spring.security.oauth2.resourceserver.jwt.jwk-set-uri:http://13.239.118.235:9090/realms/flash-ticket/protocol/openid-connect/certs}")
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchange -> exchange
                        ...
                        // User Service
                        .pathMatchers(HttpMethod.GET, "/api/v1/users/organizers/{organizerId}").permitAll()

                        // AI Service
                        .pathMatchers(HttpMethod.GET, "/api/v1/recommendations/events").permitAll()
                        .pathMatchers(HttpMethod.GET, "/api/v1/recommendations/popular").permitAll()
                        ...
                        // AI Service
                        .pathMatchers("/api/v1/analytics/admin/**").hasAuthority("ROLE_ADMIN")

                        // User Service
                        .pathMatchers(HttpMethod.GET, "/api/v1/users/organizers/me").hasAuthority("ROLE_ORGANIZER")
                        .pathMatchers(HttpMethod.PUT, "/api/v1/users/organizers/me").hasAuthority("ROLE_ORGANIZER")

                        // Core Service
                        .pathMatchers("/api/v1/organizer/**").hasAuthority("ROLE_ORGANIZER")

                        // AI Service
                        .pathMatchers("/api/v1/analytics/organizer/**").hasAuthority("ROLE_ORGANIZER")

                        // User Service
                        .pathMatchers(HttpMethod.POST, "/api/v1/users/organizers/register").hasAuthority("ROLE_BUYER")
                        ...
                        // AI Service
                        .pathMatchers("/api/v1/recommendations/for-you").authenticated()
                        .pathMatchers("/api/v1/analytics/dashboard").authenticated()
