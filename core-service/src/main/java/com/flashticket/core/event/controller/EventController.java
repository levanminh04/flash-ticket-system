...
public class EventController {
    ...
    @GetMapping("/{eventIdOrSlug}/seat-map")
    public ResponseEntity<SeatMapResponse> getSeatMap(
        @PathVariable String eventIdOrSlug
    ) {
        log.info("GET /api/events/{}/seat-map - Fetching public seat map", eventIdOrSlug);

        SeatMapResponse response = seatMapSyncService.getPublicSeatMap(
            eventService.resolveEventIdByIdOrSlug(eventIdOrSlug));
