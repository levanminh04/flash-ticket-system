    ...
    <div class="login-card">
        ...
        <div class="social-login">
            ...
            <div class="social-buttons">
                <!-- Social login logic by Keycloak standard -->
                <#if social.providers??>
                ...
                <#else>
                    <!-- Static placeholders cho giao diện -->
                    ...
                    <button type="button" class="btn-social btn-facebook">
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M16.67 15.54l.53-3.5h-3.32v-2.27c0-.95.47-1.88 1.96-1.88h1.51V4.92s-1.37-.24-2.68-.24c-2.73 0-4.54 1.68-4.54 4.7v2.73H7.08v3.5h3.04V24c2.66.42 5.4.42 8.02 0v-8.46h3.53z" fill="#fff"/>
                        </svg>
                        Facebook
                    </button>
                </#if>
